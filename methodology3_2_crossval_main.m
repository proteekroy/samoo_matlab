...
%This file performs k-fold cross valiaditon for Framework 3-2

function  [returnval] = methodology3_2_crossval_main(opt, TrainIndex, TestIndex, k)
    ...
    for i=1:k
        [sep(i), yerror(i)] = methodology3_2_crossval(opt, opt.archive(TrainIndex{i},:), opt.archive(TestIndex{i},:), ...
...
function [sep, yerror] =  methodology3_2_crossval(opt, xtrain, xtest, ASF, TrainIndex, TestIndex, cons_train, cons_test)
