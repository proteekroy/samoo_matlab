...
%This file performs k-fold cross valiaditon for Framework 2-1

function  [returnval] = methodology2_1_crossval_main(opt, TrainIndex, TestIndex, k)
    ...
    for i=1:k
        [sep(i), yerror(i)] = methodology1_1_crossval(opt, opt.archive(TrainIndex{i},:), opt.archive(TestIndex{i},:), ...
            ...
            opt.archiveCVModified(TrainIndex{i},:), opt.archiveCVModified(TestIndex{i},:));
    end
